...
class SpecializationError<T> implements HomeState<T> {
  const SpecializationError({required this.apiErrorModel});
...
@override
String toString() {
  return 'HomeState<$T>.specializationError(apiErrorModel: $apiErrorModel)';
}
